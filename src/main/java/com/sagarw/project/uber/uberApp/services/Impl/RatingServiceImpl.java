...
import com.sagarw.project.uber.uberApp.entities.Rating;
...
import com.sagarw.project.uber.uberApp.repositories.RatingRepository;
...
public class RatingServiceImpl implements RatingService {
    ...
    public DriverDto rateDriver(Ride ride, Integer rating) {
        ...
        Rating ratingObj = ratingRepository.findByRide(ride).orElseThrow(() ->
                new ResourceNotFoundException("Rating not found with ride for id " + ride.getId()));
